...
// Even you fixed the size of vector, while creation. You can append element after the size exceeds using push_back() method.
#include <iostream>
...
int main () {
    ...
    cout<<vowels[0]<<endl; // displaying data with square bracket. We can also get data using this.
    cout<<vowels[4]<<endl;
    ...
    cout<<scores.at(0)<<endl; // displaying data with at method. We can also get data using this.
